...
describe("CallToAction", () => {
  it("renders the local-first Madora message, download link, and workspace preview", () => {
    render(<CallToAction />);
    ...
    expect(screen.getByRole("img", { name: "Madora 本地 Markdown 工作区预览" })).toHaveAttribute(
      "src",
      expect.stringContaining("madora-workspace-hero.png"),
    );
  });
});
