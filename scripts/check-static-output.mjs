...
const requiredAssets = [
  ...
  "capability-local-workspace.png",
  "capability-inbox-daily.png",
  "capability-git-sync-panel.png",
  "pricing-background.webp",
  "pricing-background-render.avif",
  "testimonial-local-notebooks.jpg",
  "testimonial-avatar-writer.png",
  "testimonial-avatar-project-lead.png",
  "testimonial-avatar-knowledge-worker.png",
  "cta-dashboard.png",
